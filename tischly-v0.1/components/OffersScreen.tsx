...
import { Tag, Check, Star, Gift } from 'lucide-react'
    ...
    <div className="p-5 space-y-5">
      ...
      <div className="flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-purple-600/20 to-violet-600/10 border border-purple-500/30">
        ...
        <div className="ml-auto text-right flex-shrink-0">
          <p className="text-purple-400 font-bold text-xl">240</p>
          <p className="text-stone-500 text-xs">Punkte</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {offers.map(offer => {
          ...
          return (
            ...
            >
              {/* Emoji banner */}
              <div className="h-20 bg-gradient-to-r from-amber-500/20 to-orange-500/10 flex items-center justify-center text-5xl">
